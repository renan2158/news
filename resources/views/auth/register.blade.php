@extends('layouts.app', ['class' => 'register-page', 'page' => _('Página de Cadastro'), 'contentClass' => 'register-page'])
                ...
                <form class="form" method="post" action="{{ route('register') }}">
                    ...
                    <div class="card-body">
                        ...
                        <div class="input-group">
                            ...
                            <input type="password" name="password_confirmation" class="form-control" placeholder="{{ _('Confirmação da Senha') }}">
                        </div>
