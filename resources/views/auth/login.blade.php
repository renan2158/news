@extends('layouts.app', ['class' => 'login-page', 'page' => _('Página de Login'), 'contentClass' => 'login-page'])
        ...
        <form class="form" method="post" action="{{ route('login') }}">
            ...
            <div class="card card-login card-white">
                <div class="card-header">
                    ...
                    <h1 class="card-title">{{ _('Logar') }}</h1>
                </div>
                <div class="card-body">
                ...
                <div class="card-footer">
                    <button type="submit" href="" class="btn btn-primary btn-lg btn-block mb-3">{{ _('Logar') }}</button>
                    <div class="pull-left">
                        <h6>
